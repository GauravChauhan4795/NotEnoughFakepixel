...
public class CrystalHollowsMap extends Gui {
    ...
    public void onRenderOverlay(RenderGameOverlayEvent event) {
        ...
        // Restore vanilla icon texture and color after rendering
    ...
    private void drawPlayer(int x, int y, int w) {
        ...
        final ResourceLocation arrowTex = getArrowTexture(px, pz);
        ...
        try {
            ...
            Logger.logErrorConsole("Failed to render Crystal Hollows player arrow: " + ex.getMessage());
        } finally {
            GlStateManager.disableBlend();
            GlStateManager.popMatrix();
        }
    ...
    private static @NotNull ResourceLocation getArrowTexture(double px, double pz) {
